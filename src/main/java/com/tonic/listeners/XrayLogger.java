...
import static com.tonic.utils.EncryptionUtils.*;
...
import com.tonic.utils.XrayConfigManager;
import com.tonic.utils.XrayHttpClient;
import com.tonic.utils.TestExecutionPayloadBuilder;
import com.tonic.utils.XrayValidationUtils;
import com.tonic.exceptions.XrayException;
import com.tonic.exceptions.ErrorCode;
import org.json.JSONArray;
import org.json.JSONException;
import org.json.JSONObject;
import com.tonic.utils.JiraServiceProvider;
import java.io.InputStream;
import com.tonic.utils.EncryptionUtils;
...
public class XrayLogger {
    ...
    public static void initializeTestExecutionKey() {
        ...
        if (execId == null || execId.trim().isEmpty()) {
            ...
            execId = com.tonic.utils.PropertyBuilder.getPropValue(ConfigProperties.JIRA_EXEC_ID);
        }
        
        logger.debug("System property execId: {}", System.getProperty("execId"));
        logger.debug("Config property execId: {}", com.tonic.utils.PropertyBuilder.getPropValue(ConfigProperties.JIRA_EXEC_ID));
    ...
    private static String getExecIdFromSystemOrConfig() {
        ...
        return com.tonic.utils.PropertyBuilder.getPropValue(ConfigProperties.JIRA_EXEC_ID);
    }
    ...
    public static boolean associateTestsWithCurrentTestPlan(List<String> testsToAdd, List<String> testsToRemove) {
        ...
        String currentTestPlanKey = com.tonic.utils.PropertyBuilder.getPropValue(com.tonic.enums.ConfigProperties.JIRA_PLAN_ID);
    ...
    public static boolean associateTestsWithTestPlan(String testPlanKey, List<String> testsToAdd, List<String> testsToRemove) {
        ...
        try {
            ...
            String jiraUrl = com.tonic.utils.PropertyBuilder.getPropValue(com.tonic.enums.ConfigProperties.JIRA_URL);
            String encryptedEmail = com.tonic.utils.PropertyBuilder.getPropValue(com.tonic.enums.ConfigProperties.JIRA_EMAIL_ENCRYPTED);
            String encryptedToken = com.tonic.utils.PropertyBuilder.getPropValue(com.tonic.enums.ConfigProperties.JIRA_TOKEN_ENCRYPTED);
            ...
            // Decrypt credentials
            String email = com.tonic.utils.EncryptionUtils.decrypt(encryptedEmail);
            String token = com.tonic.utils.EncryptionUtils.decrypt(encryptedToken);
    ...
    private static String getJiraIssueInternalId(String issueKey, String bearerToken) {
        ...
        try {
            ...
            String email = com.tonic.utils.EncryptionUtils.debugDecrypt(encryptedEmail, secretKey, "getJiraIssueInternalId - email");
            String token = com.tonic.utils.EncryptionUtils.debugDecrypt(encryptedToken, secretKey, "getJiraIssueInternalId - token");
    ...
    public static String getCurrentTestExecutionKey() {
        ...
        // Then check config properties
        String configExecId = com.tonic.utils.PropertyBuilder.getPropValue(ConfigProperties.JIRA_EXEC_ID);
    ...
    public static String getCurrentTestPlanKey() {
        ...
        // Then check config properties
        String configPlanKey = com.tonic.utils.PropertyBuilder.getPropValue(ConfigProperties.JIRA_PLAN_ID);
    ...
    private static JiraCredentials loadJiraCredentials() {
        ...
        String email = com.tonic.utils.EncryptionUtils.debugDecrypt(encryptedEmail, secretKey, "attachReportToTestExecution - email");
        String token = com.tonic.utils.EncryptionUtils.debugDecrypt(encryptedToken, secretKey, "attachReportToTestExecution - token");
    ...
    private static void debugDecrypt(String encryptedText, String secretKey, String context) {
        try {
            String decrypted = com.tonic.utils.EncryptionUtils.debugDecrypt(encryptedText, secretKey, context);
