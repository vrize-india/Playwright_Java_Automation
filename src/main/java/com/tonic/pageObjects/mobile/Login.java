package com.tonic.pageObjects.mobile;

import com.tonic.common.mobile.BasePage;
import com.tonic.enums.WaitEnums;
import io.appium.java_client.AppiumDriver;
import org.testng.Assert;

import static com.tonic.utils.PropertyBuilder.getEnvPropValue;
...
public class Login extends BasePage {
    ...
    private String getCurrentEnvironment() {
        try {
            return com.tonic.utils.PropertyBuilder.getCurrentEnvironment();
        } catch (Exception e) {
