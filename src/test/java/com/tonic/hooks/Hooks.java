...
import com.tonic.utils.MobileScreenshotUtils;
import com.tonic.utils.PlaywrightScreenshotUtils;
    ...
    public static void startAppiumServer() throws IOException, InterruptedException {
        if (appiumProcess == null || !appiumProcess.isAlive()) {
            ...
            String device = System.getProperty(
                    "device",
                    PropertyBuilder.getPropValue(com.tonic.enums.ConfigProperties.ANDROID)
            );
            ...
            String driverFlag = "ios".equalsIgnoreCase(device)
                    ? PropertyBuilder.getPropValue(com.tonic.enums.ConfigProperties.AUTOMATION_NAME_IOS)
                    : PropertyBuilder.getPropValue(com.tonic.enums.ConfigProperties.AUTOMATION_NAME_ANDROID);
