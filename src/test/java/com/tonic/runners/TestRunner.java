...
import com.tonic.listeners.XrayListener;
...
@CucumberOptions(
        ...
        plugin   = {
                ...
                "com.tonic.listeners.XrayCucumberPlugin",
                "com.tonic.listeners.CucumberRetryListener"
        },
...
@Listeners({ AllureTestNg.class, XrayListener.class, com.tonic.listeners.CustomChainTestReporter.class })
